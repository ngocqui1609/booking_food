          ...
          <div className="collapse navbar-collapse" id="navbarNavDropdown">
            <ul className="navbar-nav">
              <li className="nav-item">
                <a className="nav-link" href="#Break Your Fast">
                  Break Your Fast
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="#Time for Lunch">
                  Time for Lunch
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="#Can I Have Snacks">
                  Can I Have Snacks
                </a>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <a className="nav-link" href="#Burgers and Beverages">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  <li>
                    <a className="dropdown-item" href="#Pizzanians">
                      Pizzanians
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a className="dropdown-item" href="#Chick and Chicken">
                      Chick and Chicken
                    </a>
                  </li>
